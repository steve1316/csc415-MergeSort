...
##    go to "Main Class:" and choose "Tester" as the main class to start from.
## 4. Then you are done and can now run/debug this project.
##
## Notes: Since this project is designed to handle generic data types, the project is using an array of Integer objects to 
##        demonstration purposes. There is another array commented out containing String objects if you want to test Strings.
##        Otherwise, remove them and test your own array of data types of your choosing. Adjust name of your array accordingly.